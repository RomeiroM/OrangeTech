...
### :memo: Java é agora utilizada praticamente em todo lugar:
...
Versão | Data | Recurso
:----: | :--: | :---:
JDK 1.0 | 23 de Janeiro de 1996 | É a 1ª vesão sendo hoje usada para compatibilidade de browsers mais antigos.
JDK 1.1 | 19 de Fevereiro de 1997 | Muitas bibliotecas adicionadas, das quais se destacaram o Java RMI, JavaBeans, novo modelo de eventos e JDBC driver, para conexão com banco de dados.
 ...
 J2SE 11.4 | 6 de Fevereiro de 2002 | Foi criada a palavra reservada "assert", biblioteca NIO, entre outros.
 **J2SE 5.0** | **30 de Setembro de 2004** | **Introdução dos Generics, Enumeração, Auto-boxing, for-each entre outors.**
 JAVA SE 6 | 11 de Desembro de 2006 | Obteve uma melhora significativa na performace e na estabilidade, tendo o surgimento do JIT.
 JAVA SE 7 | 28 de Julho de 2011 | Suporte ao uso de string em condições do switch, inferência na criação de objetos com tipo genéricos, simplificação na invocação de métodos com parâmetros VarArgs e tipos genéricos, entre outros.
 **JAVA SE 8** | **18 de Março de 2014** | **Expressões Lambdas, forEach, Consumer e interfaces no java.util.functions, Deafoult methods, Method references e etc.**
 JAVA SE 9 | 21 de Setembro de 2017 | Uma dass novidades dessa versão, são os factory methods para coleções.
JAVA SE 10 | 20 de Março | Dentre as novidades do JAVA 10 podemos apontar a nova API para criação de coloções imutáveis e a nova forma de se declarar variáveis locais.
**JAVA SE 11** | **25 de Setembro de 2018** | **Métodos readString() writeString(). Alguns métodos foram adicionados no tocante a manipulação de cordas como repeat, strip, stripLeading, stripTrailing, lines e isBlank. Também vale ressaltar a utilização de variáveis por inferência.**
...
JAVA SSE 17 LST | Setembro de 2021 | Entre os novos recursos da nova versão do Java padrão, estão o suporte a filtros de desserialização específicos do contexto, que é um aprimoramento de segurança e uma visualização de correspondência de padrões para instruções switch.
